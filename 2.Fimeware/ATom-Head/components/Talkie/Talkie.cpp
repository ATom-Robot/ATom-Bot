...
#define ISR_RATIO (25000/ (1000000.0f / (float)SAMPLE_RATE) )
        hw_timer_t *timer = timerBegin(0, 80, true);
        timerAttachInterrupt(timer, &timerInterrupt, true);
        timerAlarmWrite(timer, (getApbFrequency() / APB_FREQUENCY_DIVIDER) / SAMPLE_RATE, true);
        timerAlarmEnable(timer);// sampling frequency 8KHz
        setup = 1;
    }
