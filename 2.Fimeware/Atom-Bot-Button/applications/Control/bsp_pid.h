...
// left wheel pid
#define PID_KP_POS_L             (0.003)
#define PID_KI_POS_L             (0.000)
#define PID_KD_POS_L             (0.004)

#define PID_KP_VEL_L             (0.110)
#define PID_KI_VEL_L             (0.000)
#define PID_KD_VEL_L             (0.001)

// right wheel pid
#define PID_KP_POS_R             (0.003)
#define PID_KI_POS_R             (0.000)
#define PID_KD_POS_R             (0.004)

#define PID_KP_VEL_R             (0.110)
#define PID_KI_VEL_R             (0.000)
#define PID_KD_VEL_R             (0.001)
